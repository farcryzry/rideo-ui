...
<html lang="en">
  ...
  <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
          ...
          <li class="active"><a href="workflow"><span class="glyphicon glyphicon-tasks" lang-key="nav-workflow"> Workflow</span></a></li>
      </ul>
      <ul class="nav nav-sidebar">
          ...
          <div class="panel panel-default">
              ...
              <table class="table">
                  ...
                  <tr>
                      ...
                      <th style="width:15%">Worflow Status</th>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
